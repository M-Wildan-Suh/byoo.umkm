<div x-data="{ isOpen: false }" class=" flex sticky bottom-0">
    <div class=" w-full mb-2 sm:mb-4 left-0 px-4 z-40">
        <div class=" w-full max-w-xl rounded-full bg-[#F8FAFC] shadow-md shadow-black/50 py-2 text-xs sm:text-sm grid grid-cols-3 mx-auto">
