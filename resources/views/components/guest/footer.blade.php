<div class=" w-full bg-[#4b5d70]">
    <div class=" w-full min-h-10 h-10">
        <svg id="visual" viewBox="0 0 1200 40" class=" rotate-180 w-full h-full" preserveAspectRatio="none"
    ...
    <div class=" w-full px-4 pb-24 pt-12 sm:pt-20">
                            ...
                            <div class=" flex flex-row gap-2 items-center">
                                <div class=" w-4 h-4">
                                    <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path
                                            d="M13.25 21.59a30.12 30.12 0 0 0 13.18 13.17l4.4-4.41c.55-.55 1.34-.71 2.03-.49C35.1 30.6 37.51 31 40 31c1.11 0 2 .89 2 2v7c0 1.11-.89 2-2 2C21.22 42 6 26.78 6 8a2 2 0 0 1 2-2h7c1.11 0 2 .89 2 2 0 2.49.4 4.9 1.14 7.14.22.69.06 1.48-.49 2.03l-4.4 4.42z"
                            ...
                            <div class=" flex flex-row gap-2 items-center">
                                <div class=" w-4 h-4">
                                    <svg viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path
                                            d="M20 3H4C1.8 3 0 4.8 0 7v10c0 2.2 1.8 4 4 4h16c2.2 0 4-1.8 4-4V7c0-2.2-1.8-4-4-4zm1.6 5.8-7.9 5.3c-.5.3-1.1.5-1.7.5s-1.2-.2-1.7-.5L2.4 8.8c-.4-.3-.5-.9-.2-1.4.3-.4.9-.5 1.4-.2l7.9 5.3c.3.2.8.2 1.1 0l7.9-5.3c.5-.3 1.1-.2 1.4.3.2.4.1 1-.3 1.3z"
                                            fill="currentColor" class="fill-000000"></path>
                                    </svg>
                                </div>
                                <p>info@pages.id</p>
                            ...
                            <div class=" flex flex-row gap-2 items-center">
                                <div class=" w-4 h-4">
                                    <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path
                                            d="M128 16a88.1 88.1 0 0 0-88 88c0 75.3 80 132.2 83.4 134.6a8.3 8.3 0 0 0 9.2 0C136 236.2 216 179.3 216 104a88.1 88.1 0 0 0-88-88Zm0 56a32 32 0 1 1-32 32 32 32 0 0 1 32-32Z"
                                            fill="currentColor" class="fill-000000"></path>
                                    </svg>
                                </div>
                            ...
                            <div
                                ...
                                <svg viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path
                                        ...
                                        fill-rule="nonzero" fill="currentColor" class="fill-000000"></path>
                                </svg>
                            </div>
                            <div
                                class=" w-8 sm:w-12 aspect-square flex items-center justify-center bg-white rounded-full p-2 sm:p-3 text-[#4b5d70]">
