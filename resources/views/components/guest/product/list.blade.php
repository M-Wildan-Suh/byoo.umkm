        ...
        <form id="myForm" action="{{ route('order') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-3">
                @foreach ($data->productHighlight as $item)
                    <div style="background-color: {{ $template->product_main_color }};" class="w-full p-3 rounded-xl flex gap-2 text-white">
                        <div class="min-w-24 h-24 aspect-square rounded-full overflow-hidden ">
