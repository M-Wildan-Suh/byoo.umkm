    ...
    <div x-show="open" class="fixed inset-0 z-40 px-4 bg-black bg-opacity-50 flex items-center justify-center">
        <div
            ...
            <div class=" text-sm sm:text-base text-neutral-600 pt-6 space-y-4 overflow-auto max-h-96">
                <p>Selamat datang di byoo.link Dengan mengakses atau menggunakan website ini, Anda setuju untuk terikat
                ...
                <div class=" space-y-2">
                    ...
                    <p>
                        Website byoo.link adalah platform online yang memungkinkan pengguna untuk memposting, membeli,
                ...
                <div class=" space-y-2">
                    ...
                    <ul class=" list-disc pl-4">
                        ...
                        <li>Website byoo.link hanya berfungsi sebagai perantara dan tidak menjamin kualitas, keaslian,
