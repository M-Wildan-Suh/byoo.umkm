<div class=" mx-auto rounded-md bg-white min-h-screen relative">
    <div class=" space-y-6">
        <div class=" min-h-screen pt-6 relative space-y-4 bg-gradient-to-b from-[#cdeef5] to-[#B1F0F7]">
            <div class=" flex flex-col justify-center items-center py-4 md:py-8 px-4 gap-4 relative text-[#1b5c78]">
            ...
            <div class=" w-full max-w-[640px] mx-auto px-4 sm:px-0 relative">
                <!-- Accordion Item 1 -->
                <div  x-data="{ open: null }" class="p-4 space-y-4 bg-[#81BFDA] rounded-md ">
                    <button
            ...
            <div class=" w-full sticky bottom-0 py-2 px-4 sm:px-8 z-30 rounded-b-md">
                <div class="grid {{ $data->home_button === 'on' ? 'grid-cols-2' : 'grid-cols-1' }} gap-2 w-full max-w-[640px] mx-auto">
                    @if ($data->home_button === 'on')
                        <a href="{{route('home')}}">
                            <button
                                class=" text-base w-full py-2 border rounded-md text-white bg-[#ffd864] border-[#ffd864] hover:text-white hover:bg-[#e6c154] hover:border-[#e6c154] hover:font-black duration-300 relative shadow-md shadow-black/20">
                    ...
                    <a href="https://wa.me/{{ $no_tlp ?? '' }}">
                        <button
                            class=" text-base w-full py-2 border rounded-md bg-[#81BFDA] text-white border-[#81BFDA] hover:text-white hover:bg-[#629bb3] hover:border-[#629bb3] hover:font-black duration-300 relative shadow-md shadow-black/20">
                            <div class=" absolute w-5 aspect-square top-1.5 sm:top-2.5 left-2">
