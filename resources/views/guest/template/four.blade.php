<div class=" mx-auto rounded-md bg-white min-h-screen relative">
    <div class=" space-y-6">
        <div class=" min-h-screen pt-6 relative space-y-4">
            <div class=" absolute top-0 left-0 w-full h-full flex items-center justify-center">
                <img src="{{ asset('assets/images/four.jpg') }}" class=" w-full h-full object-cover" alt="">
            ...
            <x-guest.description color="#00b0ad" :data="$data" />
                    ...
                    <div class=" grid grid-cols-1 gap-3">
                        @foreach ($data->productHighlight as $item)
                            @php
                                ...
                                $colors = ['#00596b', '#00b0ad']; // Biru gelap kehijauan, Kuning
            ...
            <x-guest.contact :role="$role" classa="text-white bg-[#00596b] border-[#00596b] hover:text-white hover:bg-[#16424b] hover:border-[#16424b]" classb="bg-[#00b0ad] text-white border-[#00b0ad] hover:text-white hover:bg-[#1f7675] hover:border-[#1f7675]" :data="$data" :notlp="$no_tlp"/>
        </div>
    </div>
</div>