                                ...
                                <div class=" w-full flex flex-col h-full justify-center gap-2 sm:gap-4 text-white py-[20%] px-[10%]">
                                    ...
                                    <div class=" flex">
                                        <a href="https://wa.me/{{ $notlp ?? '' }}">
                                            <button class=" w-auto px-1 sm:px-3 py-[1px] sm:py-1 bg-[#8E1616] text-white rounded-sm text-[9px] sm:text-base font-bold">Hubungi Kami</button>
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div x-data="{ checkedItems: [] }" class=" w-full">
                                            ...
                                            @if ($role === "admin" || $role === "premium")
                                                <div class="rounded-md">
                                                    ...
                                                    <label 
                                                        ...
                                                        class="duration-300 rounded-md py-1 px-3 text-sm bg-[#8E1616] cursor-pointer border-2 border-white">
                                                        Beli
                                                    </label>
                                                </div>
                                            @endif
                    ...
                    <div 
                        ...
                        <div 
                            ...
                            class="absolute top-full mt-0 right-0 py-3 px-3 bg-black text-white rounded-md rounded-tr-none w-72 flex flex-col gap-2">
