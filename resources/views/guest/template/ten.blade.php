<div class=" mx-auto rounded-md font-dynapuff bg-white min-h-screen relative">
    <div class=" space-y-6">
        ...
        <div class=" w-full max-w-[640px] mx-auto px-4 sm:px-0 relative">
            <!-- Accordion Item 1 -->
            <div  x-data="{ open: null }" class="p-4 space-y-4 bg-[#001358] rounded-md ">
                <button
        ...
        <div class=" w-full sticky bottom-0 bg-white/30 py-2 px-4 sm:px-8 backdrop-blur-md z-30 rounded-b-md">
            <div class="grid {{ $data->home_button === 'on' ? 'grid-cols-2' : 'grid-cols-1' }} gap-2 w-full max-w-[640px] mx-auto">
                @if ($data->home_button === 'on')    
                    <a href="{{route('home')}}">
                        <button
                            class=" text-base w-full py-2 border rounded-md text-white bg-[#03497d] border-[#03497D] hover:text-white hover:bg-[#003156] hover:border-[#003156] duration-300 relative">
                            <div class=" absolute w-5 aspect-square top-1/2 -translate-y-1/2 left-2">
                ...
                <a href="https://wa.me/{{ $no_tlp ?? '' }}">
                    <button
                        class=" text-base w-full py-2 border rounded-md bg-[#4b91b1] text-white border-[#4b91b1] hover:text-white hover:bg-[#37718c] hover:border-[#37718c] duration-300 relative">
                        <div class=" absolute w-5 aspect-square top-1/2 -translate-y-1/2 left-2">
