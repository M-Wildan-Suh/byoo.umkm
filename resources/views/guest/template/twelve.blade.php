<div class=" mx-auto rounded-md bg-white min-h-screen relative">
    <div class=" space-y-6">
        <div x-data="{ checkedItems: [] }" class=" min-h-screen pt-6 relative space-y-4 bg-gradient-to-b bg-neutral-100">
            ...
            <div class=" w-full max-w-[640px] mx-auto px-4 sm:px-0 relative">
                <!-- Accordion Item 1 -->
                <div class="p-4 bg-[#8b5cf6] space-y-4 rounded-md text-white">
                    <button
                                        ...
                                        <div class="w-full flex items-end justify-between">
                                            ...
                                            <div class="bg-black rounded-md">
                                                ...
                                                <button type="button" 
                                                        ...
                                                        class="duration-300 rounded-md py-1 px-3 text-sm bg-blue-400">
                                                    Pesan
                                                </button>
                                            </div>
                                        </div>
            ...
            <div x-show="checkedItems.length > 0" class="sticky bottom-0">
                <div class="w-full sticky bottom-0 py-2 px-4 sm:px-8 z-30 rounded-b-md">
                    <div class="grid grid-cols-1 gap-4 w-full max-w-[640px] mx-auto">
                        <button onclick="document.getElementById('order').submit();" class="text-base w-full flex flex-col items-center py-2 border rounded-md bg-[#FCC737] text-white border-[#FCC737] hover:text-white hover:bg-[#d2ab41] hover:border-[#d2ab41] duration-300 relative">
